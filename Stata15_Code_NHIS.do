...
*		Variables needed: REGION, YEAR, INTERVWMO, BIRTHMO, BIRTHYR, YRSINUS, HISPYN, USBORN, CITIZEN, RACEBR, MARST, EDUC, POORYN,	*
...
***			 TABLES 2,4,6,7		 		***
*******************************************
global maincontrols intafterelignow dacaelignow afterdaca i.age somecol coldegree male /// 
...
keep if age >= 18 & age <= 50
keep if hsdegree == 1 | somecol == 1 | coldegree == 1
keep if pooryn == 2 /* Below poverty threshold */

areg selfhealth $maincontrols [pweight = perweight], a(region) robust
sum selfhealth if e(sample)==1
outreg2 using NHIS_Table7, excel replace se keep(intafterelignow dacaelignow afterdaca somecol coldegree male racewhite raceblack raceasian racenatamer married ethnichisp) bdec(4) nocons adds(Mean of Dep. Var., `r(mean)', std. dev.,`r(sd)') 

areg poor_health $maincontrols [pweight = perweight], a(region) robust
sum poor_health if e(sample)==1
outreg2 using NHIS_Table7, excel append se keep(intafterelignow dacaelignow afterdaca somecol coldegree male racewhite raceblack raceasian racenatamer married ethnichisp) bdec(4) nocons adds(Mean of Dep. Var., `r(mean)', std. dev.,`r(sd)')
